...
AngularSpringForce::AngularSpringForce(int p_index1, int p_index2, int p_index3, double ra, double dist, double ks,
                                       double kd) : m_ra(ra), m_dist(dist), m_ks(ks), m_kd(kd) {
    register_particle(p_index1);
    register_particle(p_index2);
    register_particle(p_index3);
}
